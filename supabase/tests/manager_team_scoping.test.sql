...
insert into employees (id, company_id, user_id, full_name, manager_id) values
  ...
  ('e9999999-9999-9999-9999-999999999999', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', null, 'Manager Two', null),
  ('e3333333-3333-3333-3333-333333333333', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', 'Employee Two', 'e9999999-9999-9999-9999-999999999999');
